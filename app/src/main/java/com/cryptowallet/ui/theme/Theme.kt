...
/**
 * Fixed dark/orange brand theme for the Wallet flow, matching the Wallet mockups.
 * Ignores device theme/dynamic color so the flow always renders consistently.
 */
@Composable
